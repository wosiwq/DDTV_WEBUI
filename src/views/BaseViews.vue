...
import { getBiliAccountLoginState, getBiliLoginQr, biliLoginReset } from '@/api'
import { LoginStatus } from '@/enums'
import { useSystemResourcesStore } from '@/stores/systemResources'
import { getSystemResources } from '@/api'
import type { Response, SystemResourcesData } from '@/types/response'
...
const update_store = async () => {
  getSystemResources().then((response: Response<SystemResourcesData>) => {
